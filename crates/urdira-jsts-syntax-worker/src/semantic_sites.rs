...
mod tests {
    ...
    fn typeflow_ctx(
        ...
        let index = urdira_jsts_typeflow::ProgramIndex::build(&summaries, &HashMap::new(), &HashMap::new());
    ...
    fn typeflow_resolves_the_zod_class_mixin_heritage_pattern_across_files() {
        ...
        let index = urdira_jsts_typeflow::ProgramIndex::build(&summaries, &import_targets, &HashMap::new());
        let index: &'static urdira_jsts_typeflow::ProgramIndex = Box::leak(Box::new(index));
    ...
    fn typeflow_resolves_a_member_call_through_a_named_import_of_a_namespace_reexport() {
        ...
        let index = urdira_jsts_typeflow::ProgramIndex::build(&BTreeMap::new(), &HashMap::new(), &HashMap::new());
        let index: &'static urdira_jsts_typeflow::ProgramIndex = Box::leak(Box::new(index));

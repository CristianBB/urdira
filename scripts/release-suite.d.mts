...
export function runReleaseSuite(options?: { rootDir?: string; outputDir?: string; reportPath?: string; skipInstall?: boolean; nativeRequired?: boolean; targets?: readonly string[] }): Promise<Record<string, unknown>>;

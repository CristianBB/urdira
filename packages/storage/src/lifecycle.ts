...
const MIGRATION_TABLE_NAMES = [
  ...
  "lexical_documents", "lexical_index_state", "semantic_index_state", "semantic_document_status", "artifact_dependencies", "metric_projections", "vector_shards", "vector_projection_rows",

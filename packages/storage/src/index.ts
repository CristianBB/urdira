...
export { measureDiskUsage, measureWorkspaceFootprint, removeWorkspaceFootprint, workspaceFootprintEntries, WORKSPACE_FOOTPRINT_SUFFIXES, type DiskUsage, type MeasuredWorkspaceFootprintEntry, type WorkspaceFootprintEntry, type WorkspaceFootprintEntryKind, type WorkspaceFootprintMeasurement } from "./workspace-footprint.js";
...
export { WorkspaceProjectionRepository, canonicalVectorBytes, type ArtifactDependency, type GraphEdge, type LexicalDocumentInput, type LexicalMatch, type MetricProjection, type SemanticIndexState, type VectorBatchInput, type VectorConfig, type VectorMatch, type VectorProjectionInput } from "./projections.js";

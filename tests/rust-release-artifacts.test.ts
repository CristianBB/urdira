...
describe("Rust release artifact closure", () => {
  ...
  it("stages exactly one target closure and writes its binding manifest", async () => {
    ...
    expect(manifest).toMatchObject({ target: "darwin-arm64", rust_target: "aarch64-apple-darwin", binding_api: 16, node_api: 10, worker_protocol: "urdira.ipc.v2", build_id: expect.stringMatching(/^sha256:[0-9a-f]{64}$/u) });

...
describe("Phase 6 security contracts", () => {
  ...
  it("keeps mandatory exclusions stronger than includes and git ignores", () => {
    ...
    expect(evaluateInclusion({ normalized_path: "test-results/run/generated-test.ts", is_symlink: false, is_directory: false, byte_length: 10, media_type: "text/plain" }, { include: [], exclude: [], allow_external_root: false }, { enabled: false, patterns: [] }).reason_code).toBe("security:generated_or_binary_default");
